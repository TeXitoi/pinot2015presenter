...
\begin{sloppypar}
  ...
  l'information voyageur y compris dans les transports en commun. Pour
  répondre à cette problématique, elle propose la suite logiciel
  navitia disponible en logiciel libre sur GitHub ainsi que via le
  \emph{web service} \texttt{http://navitia.io/}. Cette suite propose
